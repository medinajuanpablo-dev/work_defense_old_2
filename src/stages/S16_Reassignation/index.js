...
function ReassignationStage() {
  ...
  return (
    <StageMainScreen stageKey={MIK.STAGES.REASSIGNATION}>
      <p className={STYLES.stageName}>Reassignation Stage</p>
...
export default ReassignationStage;
